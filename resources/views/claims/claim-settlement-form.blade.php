...
<section class="app-user-list">
        ...
        <form>
            <table>
                ...
                <tr>
                    ...
                    <td colspan="3">{{$claim[0]->customer_name}} & {{$claim[0]->customer_address}}</td>
                </tr>
                <tr>
                    <th>PTCL #:</th>
                ...
                <tr>
                    ...
                    <td colspan="3">{{$claim[0]->updated_at->format('d-m-Y')}}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="3">{{$claim[0]->status == 3 ? 'Repair' :($claim[0]->status == 4 ? 'Replacement' : ($claim[0]->status == 5 ? 'Received' :($claim[0]->status == 2 ? 'Rejected' :'')))}}</td>
                </tr>
            </table>
    ...
    <div class="col-12 d-flex justify-content-between align-items-center">
                <button type="button" class="btn btn-warning col-4 mt-4 mb-4 print-button"  style="margin-bottom: 10% !important;" onclick="printForm()">Print</button>
            </div>
    </section>
@endsection
