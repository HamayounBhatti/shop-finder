    ...
    <div class="col-12">
      <div class="card" style="margin-bottom: 10%;">
        <div class="card-header">
          <h4 class="card-title">Submit Claim<small>(Distribution Side)</small></h4>
        </div>
        <div class="card-body">
        <form action="{{route('distribution.distributionSubmitRecord')}}" method="POST"  class="row">
        @csrf
        @method('PUT')
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" name="distribution_message" id="distribution_message"></textarea>
          </div>
          <div class="col-sm-10">
