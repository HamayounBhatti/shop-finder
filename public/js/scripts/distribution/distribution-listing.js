...
$(function () {
    ...
    if (dtUserTable.length) {
      ...
      var dt_filter = dtUserTable.DataTable({
        ajax: assetPath + 'distribution/get-distribution-claim-list',
        columns: [
        ...
        columnDefs: [
          ...
          },
          {
            ...
            render: function (data, type, full, meta) {
              ...
              if($invoice_image == null){
                ...
                '<img src="/storage/'+$invoice_image+'" alt="Invoice Image" width="150"></img> </span>';
            }
            }
          },
          {
          ...
          },
          {
            ...
            render: function (data, type, full, meta) {
              ...
              // if($is_closed == 1){
              //   return '<span class="text-nowrap btn btn-dark"> Closed </span>';
              // }
              if($status == 4){
